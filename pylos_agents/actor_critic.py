...
class ActorCritic(Agent):
    ...
    def __init__(self, eps=1e-3, conv_layers=4, no_of_filters=8, kernel_size=(2, 2), pool_size=(2, 2), pooling_layers=2,
        ...
        # this output is the value function
        vdense = Dense(self.dense_dim, activation='relu')(x)
        value = Dense(1, activation='tanh', name='value')(vdense)
...
class ACBatchGenerator(BatchGenerator):
