from pylos_agents.actor_critic import ACBatchGenerator
from pylos_agents.base import PlayGames
from pylos_agents import ActorCritic, SemiRandom
...
def train_agent(agent1, agent2, verbose=0):
    ...
    while epochs_wo_improvement < 5:
        ...
        gen = ACBatchGenerator(agent1=agent1, agent2=agent2, encoder=encoder, states=states, wins=wins, moves=moves,
...
if __name__ == '__main__':
    ...
    for hp in hyperparams:
        ...
        start = time.time()
        agent1 = ActorCritic(conv_layers=c, no_of_filters=nof, no_dense_layers=ndl, dense_dim=dd, batch_norm=bn,
